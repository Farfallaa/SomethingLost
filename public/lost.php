...
$advert_set = find_lost_with_limit($starting_limit_number, $results_per_page);
...
?>
    ...
    <div class='pagenumbers'>
        ...
        for ($page1=1;$page1<=$total_pages;$page1++){
            ...
            if($page1 == $page){
                echo '<a class = "current" href = "lost.php?page='.$page1.'">'.$page1. '</a> ';
            }
            else{
                echo '<a href = "lost.php?page='.$page1.'">'.$page1. '</a> ';
            }
